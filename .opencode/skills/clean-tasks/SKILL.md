---
name: clean-tasks
description: Limpa o arquivo TASKS.md mantendo sempre as ultimas 10 tarefas (feitas ou nao feitas). Remove tarefas antigas do inicio da lista.
---

## O que esta skill faz

Limpa o arquivo TASKS.md mantendo sempre as últimas 10 tarefas (feitas ou não feitas). Remove as tarefas mais antigas do início da lista.
...
**Antes (30 tarefas - 20 feitas, 10 não feitas):**
```
- ✅ Tarefa 1
- ✅ Tarefa 2
...
...
**Depois (10 tarefas - 8 feitas, 2 não feitas):**
```
- ✅ Tarefa 13
- ✅ Tarefa 14
...
...
- Quando o arquivo TASKS.md ficar muito grande
- Após muitas tarefas serem concluídas

## Arquivo de entrada

- [TASKS.md](../../docs/TASKS.md) na raiz do projeto atual

  - [TASKS.md](../../docs/TASKS.md) atualizado (mesmo arquivo)