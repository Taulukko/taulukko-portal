...
4. Ao receber notificação de conclusão da TASK + especificação do DEVELOPER, devolver ao usuário para aval final
5. Apenas se o usuário aprobar:
   - Remover o arquivo de especificação (`docs/spec/<nome>-spec.md`)
   - Marcar a task como concluída em [TASKS.md](../../docs/TASKS.md)
